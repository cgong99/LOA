...
public class BoardTest {
    ...
    public void testContiguous1() {
        ...
        ArrayList<Integer> list = (ArrayList<Integer>) b2.getRegionSizes(WP);
        ArrayList<Integer> list2 = (ArrayList<Integer>) b2.getRegionSizes(BP);
        ...
        ArrayList<Integer> list3 = (ArrayList<Integer>) b3.getRegionSizes(WP);
        ArrayList<Integer> list4 = (ArrayList<Integer>) b3.getRegionSizes(BP);
