...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("SwithSide->manual black", this::manualBlack);
        addMenuButton("SwithSide->manual white", this::manualWhite);
        addMenuButton("SwithSide->Auto black", this::autoBlack);
        addMenuButton("SwithSide->Auto white", this::autoWhite);
